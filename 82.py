...
#you can customize your own function by
#using the keyword argument key = function
#the function will return
# a number list that will be used to sort the list (the lowest number first )

#sort the list  based on how close the number is to 5
...
#the list is sorted on the based on return values :
